  ...
  return (
    <div style={{
      ...
      >
        ...
        <span style={{
          flex: 1, fontSize: 13, color: open ? '#f1f5f9' : '#94a3b8',
        ...
        <span style={{ fontSize: 10, color: '#334155', fontFamily: 'monospace', marginRight: 4 }}>
      ...
      {open && (
        <div style={{ padding: '0 18px 18px', borderTop: `1px solid ${color}20` }}>
          {/* Column hint chips */}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5, padding: '10px 0 14px' }}>
            {metric.columns.map(c => (
              <span key={c.key} style={{
                fontSize: 10, fontFamily: 'monospace',
                background: '#0f172a', color: '#475569',
                border: '1px solid #1e293b', borderRadius: 4, padding: '1px 7px',
              }}>{c.key}</span>
            ))}
          </div>
